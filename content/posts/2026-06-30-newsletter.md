...
title: "NL-RSE Community Newsletter June 2026"
date: 2026-06-30
---

<!--break-->

Welcome to the June 2026 NL-RSE Community Newsletter! After a few years hiatus, our monthly community newsletters are back, bringing you the latest news, events, and interesting reads from the world of research software in the Netherlands. Have something to share in a future edition? Submit it [_here_](https://github.com/nl-rse/website/issues?q=is%3Aissue%20state%3Aopen%20label%3Anewsletter).

Whether you're taking a break from the World Cup or staying indoors to escape the summer heat, grab yourself a refreshing drink, settle into a comfortable spot and catch up on what's been happening across the NL-RSE community.
...
Applications are open until **31 July** for teams of 2–3 people to join the Carpentries Collaborative Lesson Development Training programme which teaches skills and best practices for designing and developing open training materials. The training will take place in November 2026 and is offered as part of the DC4NES project led by 4TU.ResearchData. Read more and apply <a href="https://community.data.4tu.nl/call-for-collaborative-lesson-development-training/" style="color: #650045; font-weight: bold; font-style: italic;">here</a>.

**2026 International RSE Survey Results**  
The anonymised dataset from the 2026 International RSE Survey is now available, with responses from more than 950 research software professionals across 55 countries. This year’s survey offers insights into key areas of focus for research organisations, funders and policy makers including on the use and perception of generative AI in research software, open-source practices, and community demographics. Find out more <a href="https://www.software.ac.uk/news/rse-survey-data-release" style="color: #650045; font-weight: bold; font-style: italic;">here</a>.

**GenAI + Teaching Discussion Sessions**   
[_AI Carpentry_](https://aicarpentry.org/?mc_cid=b551e8bccf&mc_eid=c359379587) is launching a new series of GenAI + Teaching Discussion Sessions, bringing together educators to discuss the challenges and opportunities of teaching programming and data skills in the age of generative AI. Each session includes a featured presentation followed by an open discussion, giving participants the opportunity to share experiences, explore new teaching approaches, and learn from one another. Learn more and register <a href="https://aicarpentry.org/community/discussions/?mc_cid=b551e8bccf&mc_eid=c359379587" style="color: #650045; font-weight: bold; font-style: italic;">here</a>.
...
The report from the [_Research Software Engineering in the Age of Generative AI: Building a Community Vision_](https://www.researchsoft.org/events/rse-ai-workshop/?mc_cid=b551e8bccf&mc_eid=c359379587) workshop is now available. Held back in March and co-orgainzed by the Research Software Alliance, the workshop brought together members of the international RSE community to explore how generative AI could reshape the research software ecosystem and to help inform a broader community vision for the future of the field. Read the report <a href="https://www.researchsoft.org/events/rse-ai-workshop/?mc_cid=b551e8bccf&mc_eid=c359379587" style="color: #650045; font-weight: bold; font-style: italic;">here</a>.

**RSQKit v1.5.0 released**   
[_Research Software Quality Toolkit_](https://github.com/EVERSE-ResearchSoftware/RSQKit/releases/tag/v1.5.0) (RSQKit) lists curated best practices in developing, collaborating on and improving the quality of research software. It is intended for use by researchers who code, research software engineers, those managing and procuring funding for projects with a large research software component, those running research infrastructures involving software and those developing research software related policy at organisations and in projects.
