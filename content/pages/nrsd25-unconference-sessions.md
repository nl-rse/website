  ...
  <details class="group block rounded-lg bg-primary p-5 shadow-md hover:shadow-lg text-white">
    <summary class="cursor-pointer">
      <div class="flex items-center gap-4">
        <div class="flex-1 text-lg font-semibold">Making Reproducibility Happen with CODECHECK</div>
...
<div class="space-y-3 my-6">
  <details class="group block rounded-lg bg-primary p-5 shadow-md hover:shadow-lg text-white">
    <summary class="cursor-pointer">
      <div class="flex items-center gap-4">
        <div class="flex-1 text-lg font-semibold">Streaming scientific software the EESSI way</div>
        <div class="w-6 text-sm text-white/70 group-open:rotate-180 transition-transform"></div>
      </div>
    </summary>
    <div class="mt-3 text-sm text-white/90 space-y-4">
...
<div class="space-y-3 my-6">
  <details class="group block rounded-lg bg-primary p-5 shadow-md hover:shadow-lg text-white">
    <summary class="cursor-pointer">
      <div class="flex items-center gap-4">
        <div class="flex-1 text-lg font-semibold">Non-technical/Soft Skills for Research Software Engineers</div>
        <div class="w-6 text-sm text-white/70 group-open:rotate-180 transition-transform"></div>
      </div>
    </summary>
    <div class="mt-3 text-sm text-white/90 space-y-4">
...
<div class="space-y-3 my-6">
  <details class="group block rounded-lg bg-primary p-5 shadow-md hover:shadow-lg text-white">
    <summary class="cursor-pointer">
      <div class="flex items-center gap-4">
        <div class="flex-1 text-lg font-semibold">Shaping the Future of NL-RSE</div>
        <div class="w-6 text-sm text-white/70 group-open:rotate-180 transition-transform"></div>
      </div>
    </summary>
    <div class="mt-3 text-sm text-white/90 space-y-4">
...
<div class="space-y-3 my-6">
  <details class="group block rounded-lg bg-primary p-5 shadow-md hover:shadow-lg text-white">
    <summary class="cursor-pointer">
      <div class="flex items-center gap-4">
        <div class="flex-1 text-lg font-semibold">Building Local LLM Infrastructure: The Role of RSEs and the Research Community</div>
        <div class="w-6 text-sm text-white/70 group-open:rotate-180 transition-transform"></div>
      </div>
    </summary>
    <div class="mt-3 text-sm text-white/90 space-y-4">
...
<div class="space-y-3 my-6">
  <details class="group block rounded-lg bg-primary p-5 shadow-md hover:shadow-lg text-white">
    <summary class="cursor-pointer">
      <div class="flex items-center gap-4">
        <div class="flex-1 text-lg font-semibold">Open slot - Propose your topic on the day!</div>
        <div class="w-6 text-sm text-white/70 group-open:rotate-180 transition-transform"></div>
      </div>
    </summary>
  </details>
