...
The afternoon is all about turning inspiration into action. The unconference invites all participants to bring their ideas, questions, and challenges to the community. This is your chance to collaborate on the topics that matter most to you. Together, we aim to turn these conversations into tangible outcomes for the NL-RSE community, such as:
- New community events (e.g., workshops, NL-RSE meet-ups, hackathons, coding cafés). There’s an opportunity to win up to €2000 and support from the TDCC-NES team to organise a follow-up event based on an unconference session.
- Written pieces (opinion pieces, blog posts for the NL-RSE website, white papers)
- New initiatives or special interest groups
- New open-source software collaborations

#### Pitch Your Session

Throughout the day, an online form will be available for participants to propose unconference session ideas (“pitches”) and vote for their favourites. QR codes linking to the form will be displayed throughout the venue to make participation easy and accessible.

Some unconference topics have already been submitted as abstracts and selected — you can find them <tr><td><a href="/pages/nrsd25-unconference-sessions" onclick="event.stopPropagation(); return true;">here</a></td></tr>. These five pre-submitted sessions already have a guaranteed spot in the programme and will also have the opportunity to pitch. Additional topics can be proposed on the day through the online form. After the afternoon keynote, the ten top-voted pitches will be invited on stage to give a one-minute, no-slides pitch. Together with the five pre-submitted sessions, this will bring the total number of unconference sessions to fifteen.

Each accepted session will be assigned either a room (for abstract-submitted sessions) or a table (for sessions pitched on the day).

#### Share Your Outcomes

After the sessions take place and before the closing of the conference, unconference session organisers will be invited back on stage to deliver a one-minute, one-slide summary of the discussions that took place. A slide template will be provided by the event organisers.

At this stage, those who wish to participate in the TDCC-NES funding competition may briefly explain the kind of follow-up event they would organise. The audience will be invited to vote for their favourite proposal, and the winning initiative will be considered for funding.


#### TDCC-NES Funding Support

TDCC-NES offers financial support and guidance from their staff to help organise one follow-up event based on a topic discussed during a NRSD unconference session. The following restrictions apply:
