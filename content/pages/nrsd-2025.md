...
<button style="background-color: #650045; color: white; padding: 10px 20px; border: none; border-radius: 4px; cursor: pointer;" onclick="window.open('https://app.oxfordabstracts.com/stages/78755/submitter', '_blank')">
