...
Before the conference closes, session organizers will present a one-minute, one-slide summary. Organizers will provide a slide template.
...
TDCC-NES offers financial support and guidance from their staff to help organise one follow-up event based on a topic discussed during a NRSD25 unconference session. The following restrictions apply:
