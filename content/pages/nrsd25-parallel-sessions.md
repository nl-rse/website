...
<!-- eScience Center strategy -->
<div class="space-y-3 my-6">
  <details class="group block rounded-lg bg-primary p-5 shadow-md hover:shadow-lg text-white">
    <summary class="cursor-pointer">
      <div class="flex items-center gap-4">
        <div class="w-32 text-sm text-white/70 font-medium">30 min</div>
...
<!-- <div class="space-y-3 my-6">
  <details class="group block rounded-lg bg-primary p-5 shadow-md hover:shadow-lg text-white">
    <summary class="cursor-pointer">
      <div class="flex items-center gap-4">
        <div class="w-32 text-sm text-white/70 font-medium">11:25 - 12:25</div>
        <div class="flex-1 text-lg font-semibold">Research Software demos</div>
        <div class="w-6 text-sm text-white/70 group-open:rotate-180 transition-transform"></div>
      </div>
    </summary>
    <div class="mt-3 space-y-3 p-3 bg-white/5 rounded">
      <div class="flex items-start justify-between">
        <div class="pr-4">
          <div class="text-sm text-white/60">11:25 – 11:40</div>
          <div class="font-semibold">Privacy-friendly synthetic data: use-cases and challenges</div>
          <div class="text-sm text-white/70">— Raoul Schram</div>
      ...
      <div class="flex items-start justify-between">
        <div class="pr-4">
          <div class="text-sm text-white/60">11:40 – 11:55</div>
          <div class="font-semibold">Automated testing at scale</div>
          <div class="text-sm text-white/70">— Dr. Speaker Two</div>
          <p class="mt-2 text-sm text-white/90">
            Short 1–2 sentence summary summarising the technique or tool and why it matters.
          </p>
        </div>
        <NuxtLink to="/pages/sessions/session-a-talk-2" class="ml-4 text-white/90 underline">Full abstract</NuxtLink>
      </div>
    </div>
     <div class="flex items-start justify-between">
        <div class="pr-4">
          <div class="text-sm text-white/60">11:40 – 11:55</div>
          <div class="font-semibold">Challenging established HPC libraries with PartitionedArrays.jl</div>
          <div class="text-sm text-white/70">— Francesco Verdugo</div>
          <p class="mt-2 text-sm text-white/90">
            TODO:
          </p>
        </div>
