      ...
      <div v-show="$route.path == '/'" class="container mx-auto px-4">
        <div class="max-w-2xl mx-auto text-center mb-12 sm:mb-20">
          ...
          <p class="text-white my-10 slidein-animation transition">
            NL-RSE brings together the community of people writing and
            contributing to research software from Dutch universities, knowledge
            institutes, companies and other organizations to share knowledge, to
            organize meetings, and raise awareness for the scientific
            recognition of research software.
          </p>

          <NuxtLink to="/pages/nrsd2027/nrsd-2027" transition="none">
            <img
              src="~/assets/nrsd2027banner.jpg"
              alt=""
          ...
          <div class="flex gap-3 items-center justify-center max-w-3xl">
            ...
            >
              <img
                src="~/assets/video_button.webp"
                alt="Video Homepage NL-RSE"
              />
            </div>
          </div>
        </div>
